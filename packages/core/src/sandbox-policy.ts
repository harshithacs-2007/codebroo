const FORBIDDEN = [
  ...
  { re: /\bSystem\s*\.\s*(exit|halt|setSecurityManager)\b/, reason: "JVM control APIs are blocked." },
  ...
  { re: /\b(ClassLoader|URLClassLoader|MethodHandles|MethodType|AccessibleObject)\b/, reason: "Dynamic code loading/reflection is blocked." },
